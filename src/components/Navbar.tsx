    ...
    <div className="bg-gray-900 z-50 sticky top-0 shadow-lg">
      <header className="text-gray-200 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
          <span className="ml-3 text-2xl font-bold text-yellow-400">Muhammad Moiz</span>
          ...
          {/* Download CV Button */}
          <a href="/Project-2.jpg" download="Project-2.jpg" className="hidden md:inline-flex">
          ...
          {menuOpen && (
            <a href="/Project-2.jpg" download="Project-2.jpg" className="md:hidden mt-4">
